...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    // Deactivate a questionnaire using standard RESTful path
    const data = await callBackendApi(`/sessions/${sessionId}/questionnaires/${questionnaireId}/deactivate`, 'POST', null, token);
